...
const array = [
    ...
    {//array tömb második elemnek létrehozása(1st row)
    ...
    {//array tömb harmadik elemnek létrehozása(2nd row)
    ...
    {//array tömb negyedik elemnek létrehozása(3rd row)
...
szerzo.innerHTML = array[0].szerzo;//A cella tartalma az array elso elem szerzo tulajdonságának értéke lesz
...
csapat.innerHTML = array[0].csapat;//A cella tartalma az array elso elem csapat tulajdonságának értéke lesz
...
muveik.innerHTML = array[0].muveik;//A cella tartalma az array elso elem muveik tulajdonságának értéke lesz
...
szerzo1.innerHTML = array[1].szerzo//A cella tartalma az array második elem szerző tulajdonságának értéke lesz
...
csapat1.innerHTML = array[1].csapat//A cella tartalma az array második elem csapat tulajdonságának értéke lesz
...
mu11.innerHTML = array[1].mu1//A cella tartalma az array második elem mu1 tulajdonságának értéke lesz
tablarow1.appendChild(mu11)//hozzáadom a mu11 cellát a tablerow1-hez

const mu12 = document.createElement('td')// 2. mű létrehozása
mu12.innerHTML = array[1].mu2//A cella tartalma az array második elem mu2 tulajdonságának értéke lesz
...
szerzo2.innerHTML = array[2].szerzo//A cella tartalma az array harmadik elem szerző tulajdonságának értéke lesz
tablarow2.appendChild(szerzo2)//szerzo2 hozzáadása 2. sorhoz

const csapat2 = document.createElement('td')//csapat 2 létrehozása
csapat2.innerHTML = array[2].csapat//A cella tartalma az array harmadik elem csapat tulajdonságának értéke lesz
tablarow2.appendChild(csapat2)//csapat2 hozzáadása 2. sorhoz

const mu21 = document.createElement('td')// 1. mű létrehozása
mu21.innerHTML = array[2].mu1//A cella tartalma az array harmadik elem mu1 tulajdonságának értéke lesz
...
szerzo3.innerHTML = array[3].szerzo//A cella tartalma az array negyedik elem szerző tulajdonságának értéke lesz
tablarow3.appendChild(szerzo3)//szerzo3 hozzáadása a 3. sorhoz

const csapat3 = document.createElement('td')//csapat 3 létrehozása
csapat3.innerHTML = array[3].csapat//A cella tartalma az array negyedik elem csapat tulajdonságának értéke lesz
tablarow3.appendChild(csapat3)//hozzáadom a csapat3 cellát a 3. sorhoz

const mu31 = document.createElement('td')// 1. mű létrehozása
mu31.innerHTML = array[3].mu1//A cella tartalma az array negyedik elem mu1 tulajdonságának értéke lesz
tablarow3.appendChild(mu31)//hozzáadom a mu31 cellát a 3. sorhoz

const mu32 = document.createElement('td')// 2. mű létrehozása
mu32.innerHTML = array[3].mu2//A cella tartalma az array negyedik elem mu2 tulajdonságának értéke lesz
...
szerzo4.innerHTML = array[4].szerzo//A cella tartalma az array ötödik elem szerző tulajdonságának értéke lesz
tablarow4.appendChild(szerzo4)//szerzo3 hozzáadása a 4. sorhoz

const csapat4 = document.createElement('td')//csapat 4 létrehozása
csapat4.innerHTML = array[4].csapat//A cella tartalma az array ötödik elem csapat tulajdonságának értéke lesz
tablarow4.appendChild(csapat4)//csapat4 hozzáadása a 4. sorhoz

const mu41 = document.createElement('td')// 1. mű létrehozása
mu41.innerHTML = array[4].mu1//A cella tartalma az array ötödik elem mu1 tulajdonságának értéke lesz
tablarow4.appendChild(mu41)//mu41 hozzáadása a 4. sorhoz

const mu42 = document.createElement('td')// 2. mű létrehozása
mu42.innerHTML = array[4].mu2 //A cella tartalma az array ötödik elem mu2 tulajdonságának értéke lesz
